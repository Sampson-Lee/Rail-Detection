...
if __name__ == "__main__":
    ...
    vout = cv2.VideoWriter(cfg.data_root+'/deploy.avi', fourcc , 1, (img_w, img_h))
    print(cfg.data_root+'/deploy.avi')
    ...
    for i, data in enumerate(tqdm.tqdm(loader)):
        ...
        vout.write(cv2.resize(vis, (img_w, img_h)))
...
# python deploy.py configs/raildb.py --test_model /home/ssd7T/lxpData/rail/log/20220225_155405_lr_4e-04_b_64test/best_0.879.pth
